...
""",
        ...
        if not options["prod"]:
            ...
            skia.save()
            skia_profile_path = root_path / "core" / "fixtures" / "images" / "3.jpg"
            ...
            richard_profile_path = root_path / "core" / "fixtures" / "images" / "8.jpg"
...
""",
            ...
            sli.save()
            sli_profile_path = root_path / "core" / "fixtures" / "images" / "5.jpg"
            ...
            krophil.save()
            krophil_profile_path = root_path / "core" / "fixtures" / "images" / "6.jpg"
