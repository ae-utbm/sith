...
class RegisteringForm(UserCreationForm):
    ...
    class Meta:
        model = User
        fields = ("first_name", "last_name", "email", "eula_approved")
        field_classes = {"email": AntiSpamEmailField}

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["eula_approved"].required = True
        self.fields["eula_approved"].label_suffix = ""
        self.fields["eula_approved"].label = mark_safe(
            _(
